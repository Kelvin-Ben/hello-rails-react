...
**Hello-Rails-React App** is a connection between a Ruby on Rails back-end and React front-end. Its main purpose is to Understand the pros and cons of different approaches of connecting Ruby on Rails back-end with React front-end.
...
Feel free to check the [issues page](https://github.com/Kelvin-Ben/hello-rails-react/issues).
